...
class Migration_Add_video_action extends CI_Migration {
    ...
    $platform_audit_actions = array(
      array(
        ...
        'stat_page' => FALSE,
        'stat_campaign' => FALSE,
        'format_string' => '{user:user_id} viewed video {string:object} in challenge {challenge:objecti}',
        'score' => 0
      )
    );
    ...
    echo 'Updated '.$success_count.'/'.count($platform_audit_actions).' audit_actions<br />';
		echo 'Upgraded to version 14<br />';
	}

	public function down()
	{
		//Do nothing
		echo 'Downgraded to version 13<br />';
	}
}