		...
		<ul>
			...
			<li>
				...
				<?=form_textarea(array(
						  'name'        => 'package_detail',
						  'id'          => 'package_detail',
						  'value'       => set_value('package_detail'),
						  'rows'		=> '4',
						  'cols'        => '30',
			...
			<li>
				...
				<?=form_input(array(
						  ...
						  'value'       => set_value('package_max_companies'),
						  'maxlength'   => '100',
						  'size'        => '50',
			...
			<li>
				...
				<?=form_input(array(
						  ...
						  'value'       => set_value('package_max_pages'),
						  'maxlength'   => '100',
						  'size'        => '50',
			...
			<li>
				...
				<?=form_input(array(
						  ...
						  'value'       => set_value('package_max_users'),
						  'maxlength'   => '100',
						  'size'        => '50',
			...
			<li>
				...
				<?=form_input(array(
						  ...
						  'id'          => 'package_duration',
						  'value'       => set_value('package_duration'),
						  'maxlength'   => '100',
						  'size'        => '50',
