...
<?php
if(count($custom_audit_action_list) > 0){
?>

	<h1>Audit Actions</h1>
	<ul>
	<?php
		foreach ($custom_audit_action_list as $audit_action) {
...
<?php
if(count($default_audit_action_list) > 0){
?>
	<h1>Default Audit Actions</h1>
	<ul>
	<?php
		foreach ($default_audit_action_list as $audit_action) {
