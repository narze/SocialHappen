...
<head>
    ...
    <link rel="stylesheet" href="<?php echo base_url(); ?>assets/css/common/bootstrap.min.css">
    <link rel="stylesheet" href="<?php echo base_url(); ?>assets/css/common/fancybox/jquery.fancybox-2.1.4.css">
    <link rel="stylesheet" href="<?php echo base_url(); ?>assets/css/video/gashapon.css">
</head>
<body>
    <header class="navbar navbar-fixed-top" role="banner" id="navbar">
        <div class="navbar-inner">
                <a title="Home" href="/" class="brand">
                    <img height="50" alt="Home" class="hires" src="<?php echo base_url(); ?>assets/images/howto/party-logo2.png">
                </a>
                <div class="bot-nav">
                    <ul>
    ...
    <div id="impress">
            ...
            <div class="container">
                <div class="row-fluid">
                    <div class="span7 play-vdo">
                        <img src="<?php echo base_url(); ?>assets/images/howto/video-01.png" alt="">
                        <div class="btn-play" href="http://www.youtube.com/embed/AqA2_DzQDBQ?rel=0&autoplay=1&hd=1&vq=hd720"></div>
                    </div>
                    <div class="span5">
                        <h1>SocialHappen</h1>
                        <p class="subheading">SocialHappen helps retails <br>drive real foot traffic, and better <br>engage with customers.</p>
                        <a class="btn btn-primary btn-large" href="#/step-2">Tell me more</a>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="step slide" data-x="2000" data-y="1900" data-rotate="90">
            ...
            <div class="container">
                <div class="row-fluid">
                    <div class="span4 align-center"><img src="<?php echo base_url(); ?>assets/images/howto/sh-slide-01.png" alt=""></div>
                    <div class="span4 align-center"><img src="<?php echo base_url(); ?>assets/images/howto/sh-slide-02.png" alt=""></div>
                    <div class="span4 align-center"><img src="<?php echo base_url(); ?>assets/images/howto/sh-slide-03.png" alt=""></div>
                </div>
                <div class="row-fluid">
                    <div class="span4 align-center"><p class="subheading">Objects with<br> SocialHappen inside</p></div>
                    <div class="span4 align-center"><p class="subheading">Connect to customers when<br> they visit your store</p></div>
        ...
        <div class="step slide" data-x="2000" data-y="4200" data-rotate="90">
            ...
            <div class="container">
                <div class="row-fluid">
                    <img src="<?php echo base_url(); ?>assets/images/howto/sh-slide-16.png" alt="">
                </div>
            </div>
        </div>
        ...
        <div class="step slide" data-x="2000" data-y="6500" data-rotate="90">
            ...
            <div class="container">
                <div class="row-fluid">
                    <div class="span4"><img src="<?php echo base_url(); ?>assets/images/howto/sh-slide-06.png" alt=""><br /><h4>Reach out and motivate</h4><p>Reach out your marketing campaign. We tell our users what’s more to walk in when they go shopping near your store. Motivate them to visit your store through challenges and rewards system.</p></div>
                    <div class="span4"><img src="<?php echo base_url(); ?>assets/images/howto/sh-slide-07.png" alt=""><br /><h4>Connect and engage</h4><p>The purpose of a business is to create a customer who creates customers. We allow you to engage your digital presence and marketing activities with your customers easily.</p></div>
                    <div class="span4"><img src="<?php echo base_url(); ?>assets/images/howto/sh-slide-08.png" alt=""><br /><h4>Customer insights</h4><p>Good businesses learn from customers. Great ones act on it. Know who is your customers and engage them with Socialhappen now.</p></div>
                </div>
            </div>
        </div>
        ...
        <div class="step slide" data-x="0" data-y="8400" data-rotate="180">
            ...
            <div class="container">
                <div class="row-fluid">
                    <div class="span3"><img src="<?php echo base_url(); ?>assets/images/howto/sh-slide-01.png" alt=""></div>
                    <div class="span3"><img src="<?php echo base_url(); ?>assets/images/howto/sh-slide-03.png" alt=""></div>
                    <div class="span3"><img src="<?php echo base_url(); ?>assets/images/howto/sh-slide-04.png" alt=""></div>
                    <div class="span3"><img src="<?php echo base_url(); ?>assets/images/howto/sh-slide-05.png" alt=""></div>
                </div>
                <div class="row-fluid">
                    <div class="span3"><h4>Real rewarding machine</h4></div>
                    <div class="span3"><h4>Socialhappen Points,<br>and redeeming rewards</h4></div>
                    <div class="span3"><h4>Your store rewards</h4></div>
                    <div class="span3"><h4>Mobile Coupons</h4></div>
                </div>
            </div>
        </div>
        ...
        <div class="step slide" data-x="-2400" data-y="8400" data-rotate="180">
            ...
            <div class="container">
                <div class="row-fluid">
                    <div class="span5"><img src="<?php echo base_url(); ?>assets/images/howto/sh-slide-09.png" alt=""></div>
                    <div class="span7">
                        <p class="subheading">which you can mix & match your own.</p>
                        <h1 class="text-blue">Marketing Challenges</h1>
                        <p class="subheading">now you can let your customers connect to your social media, or marketing activities easily.</p>
                        <ul class="subheading unstyled text-light">
                            <li>1. Like company Fan Page</li>
                            <li>2. Motivate Check-in and Sharing</li>
                            <li>3. Give Feedback</li>
                            <li>4. Share a happy photo</li>
                            <li>and more ...</li>
                        </ul>
                    </div>
                </div>
        ...
        <div class="step slide" data-x="-4400" data-y="6500" data-rotate="270">
            ...
            <div class="container">
                <div class="row-fluid">
                    <div class="span12"><img src="<?php echo base_url(); ?>assets/images/howto/sh-slide-10.png" alt=""></div>
                </div>
                <div class="row-fluid">
                    <div class="span3 align-center"><h4>Like your page</h4></div>
                    <div class="span3 align-center"><h4>Get Feedbacks</h4></div>
                    <div class="span3 align-center"><h4>Check-in</h4></div>
                    <div class="span3 align-center"><h4>Share to complete</h4></div>
                </div>
            </div>
        </div>
        ...
        <div class="step slide" data-x="-4400" data-y="4400" data-rotate="270">
            ...
            <div class="container">
                <div class="row-fluid align-center">
                    <div class="span1"></div>
                    <img class="span10" src="<?php echo base_url(); ?>assets/images/howto/sh-slide-11.png" alt="">
                </div>
            </div>
        </div>
        ...
        <div class="step slide" data-x="-4400" data-y="2100" data-rotate="270">
            ...
            <div class="container">
                <div class="row-fluid">
                    <div class="span6"><img src="<?php echo base_url(); ?>assets/images/howto/sh-slide-12.png" alt=""></div>
                    <div class="span6">
                        <h4>With Socialhappen, you can</h4>
                        <ol class="subheading text-light">
                            <li>Motivate real walk-ins</li>
                            <li>Bring every happy moment to your company social media</li>
                            <li>Connect to your customers and learn from them</li>
                        </ol>
                    </div>
                </div>
            </div>
        ...
        <div class="step slide" data-x="-2500" data-y="0" data-rotate="360">
            ...
            <div class="container">
                <div class="row-fluid">
                    <div class="span6"><img src="<?php echo base_url(); ?>assets/images/howto/sh-slide-13.png" alt=""></div>
                    <div class="span6">
                        <h4>Contact our</h4>
                        <p class="subheading">“Retail Engagement Specialist” <br>to start something. It’s easy.</p>
                        <a href="mailto:support@socialhappen.com?Subject=Hello%20SocialHappen" class="btn btn-primary btn-large">Contact us</a>
                        <br>
                        <br>
                        <p>
                            <a href="#/step-11" class="text-white underline">Not sure? See it in action.</a>
                        </p>
                    </div>
                </div>
            </div>
    ...
    <div class="mid-nav">
        <div class="left slide-control" id="prev">‹</div>
        <div class="right slide-control" id="next">›</div>
    </div>

    <script src="<?php echo base_url(); ?>assets/js/common/jquery-1.9.1.min.js"></script>
    <script src="<?php echo base_url(); ?>assets/js/common/impress.js"></script>
    <script src="<?php echo base_url(); ?>assets/js/common/fancybox/jquery.fancybox-2.1.4.pack.js"></script>
    <script>
    $(function() {
        // Slide control
        impress().init();
        $('#prev').click(function () {
            var slide_index = parseInt(location.hash.replace('#/step-','')) - 1;
            if($('.slide').eq(slide_index).length) {
                impress().goto(slide_index-1);
            }
        });
        $('#next').click(function () {
            var slide_index = parseInt(location.hash.replace('#/step-',''));
            if($('.slide').eq(slide_index).length) {
                impress().goto(slide_index);
            } else {
                impress().goto(0);
            }
        });
        ...
        // Menu bar
        $('div.bot-nav a').click(function () {
            console.log('set active');
            $(this).addClass('active').parent().siblings().find('a').removeClass('active');
        });

        // On slide change, active menu bar
        window.onhashchange = function () {
            var slide_hash = location.hash.replace('/','');
            if($(slide_hash).length) {
