	...
	<ul>
		...
		<ul>
			<?php foreach($user_companies as $company) : ?>
				<li class="user-company-setting"><a href="<?php echo base_url()."settings/company/{$company['company_id']}";?>"><img src="<?php echo imgsize("{$company['company_image']}",'square'); ?>" /><?php echo "{$company['company_name']}"; ?></a>
					<ul>
						<?php foreach($company_pages[$company['company_id']] as $page) : ?>
							<li class="company-page-setting"><a href="<?php echo base_url()."settings/page/{$page['page_id']}";?>">&raquo;<img src="<?php echo imgsize("{$page['page_image']}",'square'); ?>" /><?php echo "{$page['page_name']}"; ?></a></li>
						<?php endforeach; ?>
					</ul>
				</li>
			<?php endforeach; ?>
