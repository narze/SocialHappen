<div id="update-campaign-form" class="app-component-form">
<?php 
...
<li <?php echo form_error('campaign_name') ? 'class="error"' : ''; ?>>
        ...
        <div class="inputs">
                <input id="campaign_name" type="text" name="campaign_name" maxlength="255" value="<?php echo set_value('campaign_name', $campaign['campaign_name']); ?>" style="width:300px;" />
        </div>
</li>
...
<li>
        ...
        <div class="inputs">                                                    
               <?php echo form_textarea( array( 'name' => 'campaign_end_message', 'style' => 'width:304px;height:100px;', 'value' => set_value('campaign_end_message',$campaign['campaign_end_message']) ) )?>
        </div>
</li>
