...
<p>
        ...
        <br /><input id="campaign_name" type="text" name="campaign_name" maxlength="255" value="<?php echo set_value('campaign_name', $campaign['campaign_name']); ?>"  />
</p>

<p>
        <label for="campaign_start_date">Campaign Start Date <span class="required">*</span></label>
        <?php echo form_error('campaign_start_date'); ?>
        <br /><input id="campaign_start_date" type="text" name="campaign_start_date" maxlength="10" value="<?php echo set_value('campaign_start_date', $campaign['campaign_start_date']); ?>"  />
</p>
...
<p>
	...
	<?php echo form_textarea( array( 'name' => 'campaign_end_message', 'rows' => '5', 'cols' => '80', 'value' => set_value('campaign_end_message',$campaign['campaign_end_message']) ) )?>
</p>
