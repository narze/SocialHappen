<div class="popup-fb">
	...
	<div class="reward-item">
		<div class="section first">
			...
			<div class="item-info">
				...
				<div class="box">
					<p><span class="tc-green6 bold">Quanity: </span><?php echo number_format($reward_item['redeem']['amount'] - $reward_item['redeem']['amount_redeemed']).'/'.number_format($reward_item['redeem']['amount']);?></p>
	...
	if($reward_item['redeem']['amount_redeemed'] === $reward_item['redeem']['amount']) //Out of stock
	{ ?>
