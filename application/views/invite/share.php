...
<body style="min-height:500px">
	<div class="popup-fb"><?php 
		...
		{ ?>
			...
			echo form_open('invite/invite_share_submit/'.$app_install_id, $attributes); ?>
			...
			<p>
				...
				<?php } ?>
				<?php if($invite['email_invite']) { ?>
				<input type="checkbox" id="email" name="email" value="1" class="cb-share-email" <?php echo set_checkbox('email', '1', $email_checked); ?>> 
