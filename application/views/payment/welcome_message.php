...
<h1>Angell EYE PayPal Payments Pro CodeIgniter Library Demo	- <a href="http://www.angelleye.com/download/angell-eye-paypal-payments-pro-codeigniter-library.zip">Download the Library</a></h1>
...
<p><?php highlight_file($_SERVER['DOCUMENT_ROOT'].'/includes/get_balance.php'); ?></p>
<p><a href="http://ci.developersandbox.net/paypal/payments_pro/get_balance" target="_blank">Run the code above and see the output.</a></p>
...
<p>
  <?php highlight_file($_SERVER['DOCUMENT_ROOT'].'/includes/do_direct_payment.php'); ?>
</p>
<p><a href="http://ci.developersandbox.net/paypal/payments_pro/do_direct_payment_demo" target="_blank">Run the code above and see the output.</a></p>
</body>
</html>