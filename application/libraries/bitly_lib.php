...
class bitly_lib {
     ...
     */
    function bitly_v3_shorten($longUrl, $domain = '', $size = 164, $x_login = '', $x_apiKey = '') {
      $result = array();
      ...
      if (isset($output->{'data'}->{'hash'})) {
        ...
        $result['url_qr'] = $output->{'data'}->{'url'}.'.qrcode?s='.$size;
