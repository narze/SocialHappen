...
class Payment extends CI_Controller {
	...
	{
		$this->load->model('order_model','orders');
		$data = array('billing_info' => $_SERVER['REMOTE_ADDR']);
		
		if (!in_array($_SERVER['REMOTE_ADDR'], array('216.113.188.202','216.113.188.203','216.113.188.204','66.211.170.66'))) { /*header("HTTP/1.0 404 Not Found");*/$this->orders->add_order($data); exit(); }
