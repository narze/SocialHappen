...
class Payment extends CI_Controller {
	...
	{
		if (!in_array($_SERVER['REMOTE_ADDR'], array('216.113.188.202','216.113.188.203','216.113.188.204','66.211.170.66'))) { /*header("HTTP/1.0 404 Not Found");*/print_r($_SERVER['REMOTE_ADDR']);  exit(); }
