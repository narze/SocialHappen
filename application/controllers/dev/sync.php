	...
	function insert_test_data(){
		$app = array(
			array(
				...
				'app_url' => 'http://apps.socialhappen.com/fgf/profile.php?app_install_id={app_install_id}', 
			...
			array(
				...
				'app_description' => 'Friend Get Fans', 
				'app_secret_key' => 'ad3d4f609ce1c21261f45d0a09effba4', 
				'app_url' => 'http://socialhappen.dyndns.org/fgf/profile.php?app_install_id={app_install_id}', 
			...
			array(
				...
				'app_url' => 'http://apps.socialhappen.com/mockapp?app_install_id={app_install_id}', 
			...
			array(
				...
				'app_description' => 'Mock Application', 
				'app_secret_key' => 'cd14463efa98e6ee00fde6ccd51a9f6d', 
				'app_url' => 'http://socialhappen.dyndns.org/mockapp?app_install_id={app_install_id}', 
			...
			array(
				...
				'app_url' => 'http://apps.socialhappen.com/feedv?app_install_id={app_install_id}', 
				'app_install_url' => 'http://apps.socialhappen.com/feedv/sh/install?company_id={company_id}&user_id={user_id}&page_id={page_id}', 
				...
				'app_support_page_tab' => 1, 
				'app_image' =>  'http://apps.socialhappen.com/feedv/app_image.png',
			...
			array(
				...
				'app_url' => 'http://socialhappen.dyndns.org/feedv?app_install_id={app_install_id}', 
				'app_install_url' => 'http://socialhappen.dyndns.org/feedv/sh/install?company_id={company_id}&user_id={user_id}&page_id={page_id}', 
				...
				'app_support_page_tab' => 1, 
				'app_image' =>  'http://socialhappen.dyndns.org/feedv/app_image.png',
			...
			array(
				...
				'app_url' => 'http://apps.socialhappen.com/feedr?app_install_id={app_install_id}', 
				'app_install_url' => 'http://apps.socialhappen.com/feedr/sh/install?company_id={company_id}&user_id={user_id}&page_id={page_id}', 
				...
				'app_support_page_tab' => 1, 
				'app_image' =>  'http://apps.socialhappen.com/feedr/app_image.png',
			...
			array(
				...
				'app_description' => 'RSS Feed', 
				'app_secret_key' => '985a868ee8aec810d3a25a3367776ea7', 
				'app_url' => 'http://socialhappen.dyndns.org/feedr?app_install_id={app_install_id}', 
				'app_install_url' => 'http://socialhappen.dyndns.org/feedr/sh/install?company_id={company_id}&user_id={user_id}&page_id={page_id}', 
				...
				'app_support_page_tab' => 1, 
				'app_image' =>  'http://socialhappen.dyndns.org/feedr/app_image.png',
