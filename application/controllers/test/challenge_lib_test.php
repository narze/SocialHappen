...
class Challenge_lib_test extends CI_Controller {
  ...
  function setup_before_test() {
    ...
    $this->challenge2 = array(
      ...
      'locations' => array(),
      'custom_locations' => array(array(10,10)),
      'branches' => array()
    );
