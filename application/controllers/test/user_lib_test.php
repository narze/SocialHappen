...
class User_lib_test extends CI_Controller {
	...
	function add_challenge_for_test() {
		...
		$this->challenge1 = $this->challenge_model->add(array('hash' => '1234'));
		$this->challenge2 = $this->challenge_model->add(array('hash' => '5678'));
		$this->challenge3 = $this->challenge_model->add(array('hash' => '0000'));
		$this->challenge4 = $this->challenge_model->add(array('hash' => '1111'));
	}
