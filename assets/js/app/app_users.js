$(function(){	
	$.getJSON(base_url+'app/json_get_users/'+app_install_id,function(json){
		for(i in json){
			...
			app_list.find('h2,p.thumb').append('<a href="'+base_url+'app/'+app_install_id+'/user/'+json[i].user_id+'">'+json[i].user_first_name+' '+json[i].user_last_name+'</a>');
