...
define(['main', 'routes/main-router', 'views/main-view', 'views/users-view', 'views/activities-view', 'views/companies-view', 'views/challenges-view', 'views/rewards-view', 'views/devices-view', 'views/sonar-codes-view', 'views/reward-machines-view', 'models/company-model', 'collections/company-collection', 'models/user-model', 'collections/user-collection', 'models/activity-model', 'collections/activity-collection', 'models/challenge-model', 'collections/challenge-collection', 'models/reward-model', 'collections/reward-collection', 'models/device-model', 'collections/device-collection', 'models/sonar-code-model', 'collections/sonar-code-collection', 'models/branch-model', 'collections/branch-collection', 'models/reward-machine-model', 'collections/reward-machine-collection'], function(Main, MainRouter, MainView, UsersView, ActivitiesView, CompaniesView, ChallengesView, RewardsView, DevicesView, SonarCodesView, RewardMachinesView, CompanyModel, CompanyCollection, UserModel, UserCollection, ActivityModel, ActivityCollection, ChallengeModel, ChallengeCollection, RewardModel, RewardCollection, DeviceModel, DeviceCollection, SonarCodeModel, SonarCodeCollection, BranchModel, BranchCollection, RewardMachineModel, RewardMachineCollection) {
  var config, env;
