define ['backbone', 'backbonePaginator', 'helpers/common', 'models/branch-model'], (Backbone, BackbonePaginator, Common, BranchModel) ->
  ...
  Collection = Backbone.Paginator.requestPager.extend
    ...
    # url: ->
    #   window.baseUrl + 'apiv3/branch_list?' + serialize(this.params)
    ...
    paginator_core:
      ...
      url: ->
        window.baseUrl + 'apiv3/branches?' + serialize(@params)
