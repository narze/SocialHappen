define ['backbone', 'backbonePaginator', 'helpers/common', 'models/challenge-model'], (Backbone, BackbonePaginator, Common, ChallengeModel) ->
  ...
  Collection = Backbone.Paginator.requestPager.extend
    ...
    paginator_core:
      ...
      url: ->
        window.baseUrl + 'apiv3/challenge_list?' + serialize(@params)
