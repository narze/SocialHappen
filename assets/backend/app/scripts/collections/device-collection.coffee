define ['backbone', 'backbonePaginator', 'helpers/common', 'models/device-model'], (Backbone, BackbonePaginator, Common, DeviceModel) ->
  ...
  Collection = Backbone.Paginator.requestPager.extend
    ...
    # url: ->
    #   window.baseUrl + 'apiv3/device_list?' + serialize(this.params)
    ...
    paginator_core:
      ...
      url: ->
        window.baseUrl + 'apiv3/devices?' + serialize(@params)
