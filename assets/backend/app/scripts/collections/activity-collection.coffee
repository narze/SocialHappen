define ['backbone', 'backbonePaginator', 'helpers/common', 'models/activity-model'], (Backbone, BackbonePaginator, Common, ActivityModel) ->
  ...
  Collection = Backbone.Paginator.requestPager.extend
    ...
    paginator_core:
      ...
      url: ->
        window.baseUrl + 'apiv3/activities?' + serialize(@params)
